...
2. Dopuszczelne jest stosowanie podkreslnikow oraz kropek, rowniez na poczatku. Zmienna z kropka na poczatku maja pewna wlanosc opisana w ksiazce Gagoleskiego. Zmienna taka bedzie tzw zmienna ukryta i nie bedzie np. widziana domyslnie przez f:ls ktora wyswietla liste zmiennych.
3. W przypadku tworzenia nazw zmiennych warto odwolac sie do regul podanych przez Wickhama w tzw. ‘Style Guide’ w jego podreczniku do zaawansowanego programowania w R. 
...
2. uzywamy go gdzy podajac argument definiujemy obiekt

```{r}
wektor <- c(1,2,3,4) # definiuje zmienna

# ad 1 : tutaj wektor to odwolanie do zmienne ktora 
sum(wektor) 
